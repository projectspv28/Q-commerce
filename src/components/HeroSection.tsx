...
function HeroSection() {
   ...
   const slides=[
      {
    id: 1,
    icon: <Leaf className="w-20 h-20 sm:w-28 sm:h-28 text-amber-400 drop-shadow-lg" />,
...
className='mt-4 bg-white text-red-700 hover:bg-amber-100 px-8 py-3 rounded-full font-semibold shadow-lg transition-all duration-300 flex items-center gap-2'
>
